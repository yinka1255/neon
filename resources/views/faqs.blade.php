...
<!-- Page Title -->
<title>Neon | Frequently asked questions</title>
...
<div id="wrapper">
  ...
  <header id="header" class="header">
    ...
    <section class="inner-header divider layer-overlay overlay-white-1" data-bg-img="{{asset('public/customer/images/faq.jpg')}}">
      <div class="container pt-70 pb-20">
        <!-- Section Content -->
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-center" style="color: #fff;">FAQs</h2>
              <ol class="breadcrumb text-center text-white mt-10">
                <li><a href="#" style="color: #fff;">Home</a></li>
                <li class="active text-silver-gray" style="color: #fff;">FAQs</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-3 scrolltofixed-container">
            <div class="list-group scrolltofixed z-index-0">
              <a href="#section-one" class="list-group-item smooth-scroll-to-target">What is Neon?</a>

              <a href="#section-two" class="list-group-item smooth-scroll-to-target">How Does Neon Work?</a>

              <a href="#section-three" class="list-group-item smooth-scroll-to-target">Will You Deliver To My Area?</a>

              <a href="#section-four" class="list-group-item smooth-scroll-to-target">When Will I Receive My Order?</a>

              <a href="#section-five" class="list-group-item smooth-scroll-to-target">How Much Will It Cost?</a>
              <a href="#section-six" class="list-group-item smooth-scroll-to-target">How Do I Pay For My Order?</a>
              <a href="#section-seven" class="list-group-item smooth-scroll-to-target">Can I Return Items?</a>
              <a href="#section-eight" class="list-group-item smooth-scroll-to-target">Can I Cancel My Order?</a>
            </div>
          </div>
          <div class="col-md-9">
            <div id="section-one" class="mb-50">
              <h3>What is Neon??</h3>
              <hr>
              <p class="mb-20">Neon is Nigeria’s first Integrative Pharmacy. We are the fastest growing pharmacy chain in West Africa, committed to our mission of helping people achieve Optimum Health and Vitality. When you shop online, our well-trained Personal Shoppers carefully pick your order and deliver them to you in as early as 3 hours after your order.!</p>
            </div>
            <div id="section-two" class="mb-50">
              <h3>How Does Neon Work?</h3>
              <hr>
              <p class="mb-20">Customers can shop on HealthPlus for items such as pharmaceutical & health products, natural remedies, beauty & skin care and everything else you’ll find in a typical integrative pharmacy. When customers add items to their order basket, they have the choice of selecting their preferred payment method from multiple options. The website is user-friendly and the service is interactive; we keep customers updated at every stage of the processing of their order.</p>
            </div>
            <div id="section-three" class="mb-50">
              <h3>Will You Deliver To My Area?</h3>
              <hr>
              <p class="mb-20">We currently serve most parts of Lagos, covering mainly central areas like Ajao Estate, Alausa, Anthony Village, Gbagada, Ijora, Ikeja, Ikoyi, Ilupeju, Ketu, Lagos Island, Lekki (up to Lagos Business School), Magodo, Maryland, Mushin, Ogba, Ogudu, Ojodu Berger, Ojota, Omole, Oniru Estate, Oregun, Oshodi, Somolu, Surulere, Victoria Island, Yaba. If your preferred delivery address is not within our current coverage area, you may provide an alternative delivery address that is centrally located (perhaps your office or the home of a relative or friend that you visit frequently).</p>
            </div>
            <div id="section-four" class="mb-50">
              <h3>When Will I Receive My Order?</h3>
              <hr>
              <p class="mb-20">At checkout, you are able to view the estimated time at which your order will be delivered. We deliver 7 days a week from 9 am to 9 pm and can be at your door in as early as 3 hours after your order. See our Terms for more details on our delivery service.</p>
            </div>
            <div id="section-five" class="mb-50">
              <h3>How Much Will It Cost?</h3>
              <hr>
              <p class="mb-20">The cost of having a Personal Shopper select items for you and deliver them directly to you at home or at the office is only N1,000 for one-time delivery.
              </p>
            </div>
            <div id="section-six" class="mb-50">
              <h3>How Do I Pay For My Order?</h3>
              <hr>
              <p class="mb-20">We accept online payments from all major Naira denominated debit and credit cards as well as international Mastercard and Visa cards. We currently do not offer any payment on delivery options.
              </p>
            </div>
            <div id="section-seven" class="mb-50">
              <h3>Can I Return Items?</h3>
              <hr>
              <p class="mb-20">If we deliver an incorrect or damaged item (damage that has been caused by us), we will happily replace the item at no additional cost to you. For us to replace such items, customers will need to notify the delivery driver of their observation at the point of delivery. Once customers have taken delivery of their order and signed confirming this, they take ownership of the items and HealthPlus will be unable to accept any returns.
              </p>
            </div>
            <div id="section-eight" class="mb-50">
              <h3>Can I Cancel My Order?</h3>
              <hr>
              <p class="mb-20">When we receive customer orders, we begin processing them immediately. Thus, once an order has been placed and paid for, HealthPlus is unable to accept a cancellation of the order.
              </p>
            </div>
          </div>
        </div>

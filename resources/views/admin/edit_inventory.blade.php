...
<head>
	...
	<title>Neon | Edit Inventory</title>
	...
	<div class="main-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<br/><br/>
				<form role="form" method="post" enctype="multipart/form-data" action="{{url('admin/update_inventory')}}" class="form-horizontal ">
					{{ csrf_field() }}
					<input type="hidden" name="id" value="{{$inventory->id}}"/>
					<div class="form-group">
						<label for="field-2" class="col-sm-2 control-label">Invoice/Receipt no.</label>
						<div class="col-sm-7">
							<input type="text" name="invoice_number" class="form-control" value="{{$inventory->invoice_number}}"  placeholder="Invoice number" required>
						</div>
					</div>
					<div class="form-group">
						<label for="field-2" class="col-sm-2 control-label">Product</label>
						<div class="col-sm-7">
							<select name="product_id" class="form-control" value="{{$inventory->product_id}}" required>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="number" name="cost_price" class="form-control" value="{{$inventory->cost_price}}" placeholder="Cost price" required>
						</div>
					</div>
					<div class="form-group">
						<label for="field-2" class="col-sm-2 control-label">Selling price</label>
						<div class="col-sm-7">
							<input type="number" name="selling_price" class="form-control" value="{{$inventory->selling_price}}" placeholder="Selling price" required>
						</div>
					</div>
					<div class="form-group">
						<label for="field-2" class="col-sm-2 control-label">Quantity</label>
						<div class="col-sm-7">
							<input type="number" name="quantity" class="form-control" value="{{$inventory->quantity}}" placeholder="Quantity" required>
						</div>
					</div>
					<div class="form-group">
						<label for="field-2" class="col-sm-2 control-label">Unit.</label>
						<div class="col-sm-7">
							<input type="text" name="unit" class="form-control" value="{{$inventory->unit}}" placeholder="eg. Pack, Blister, Carton" required>
						</div>
					</div>
					<div class="form-group">

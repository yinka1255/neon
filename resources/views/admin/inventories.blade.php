...
<head>
	...
	<title>Neon - Admin Panel| Inventory</title>
			...
			<div class="col-xs-12">
				...
				<div class="col-xs-4">
					<div class="pull-right">
							<a href="{{url('admin/new_inventory')}}" class="btn btn-primary"><i class="entypo-user"> </i> Add new</a>
					</div>
				</div>
				<table class="table table-bordered datatable" id="table-1">
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td>N{{number_format($inventory->cost_price)}}</td>
							<td>
								<a href="{{url('admin/edit_inventory/'.$inventory->id)}}" class="btn btn-default btn-sm btn-icon icon-left">
									<i class="entypo-pencil"></i>
									Edit
								</a>
								<a href="{{url('admin/delete_inventory/'.$inventory->id)}}" class="btn btn-danger btn-sm btn-icon icon-left">

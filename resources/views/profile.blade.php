        ...
        <div class="container">
          <nav id="menuzord" class="menuzord blue no-bg">
            <ul class="menuzord-menu">
              ...
              @if(Auth::check())
              <li class="active"><a style="color: #fff;" href="{{url('profile')}}">Hi, {{$loggedInUser->name}}</a>
              </li>
              @endif
      ...
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-4">
              <div class="thumb">
                <img src="{{asset('public/images/profile.png')}}" alt="">
              </div>
            </div>
            <div class="col-md-8">
              <form action="{{url('update_profile')}}" method="post">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input id="name" name="name" class="form-control" value="{{$loggedInUser->name}}" placeholder="Full Name">
                  </div>
                  <div class="form-group col-md-12">
                    <label for="checkuot-form-fname">Email</label>
                    <input id="name" name="email" class="form-control" value="{{$loggedInUser->email}}" placeholder="Email">
                  </div>
                  <div class="form-group col-md-12">
                    <label for="checkuot-form-fname">Phone</label>
                    <input id="name" name="phone" class="form-control" value="{{$loggedInUser->phone}}" placeholder="Phone">
                  </div>
                  <div class="text-right"> <button type="submit" class="btn btn-default">Update profile</button> </div>
              </form>
              <hr>
              <br/>
              <form action="{{url('update_password')}}" method="post">
                  {{ csrf_field() }}
                  <div class="form-group col-md-12">
                    <label for="checkuot-form-fname">Password</label>
                    <input name="password" type="password" class="form-control" placeholder="">
                  </div>
                  <div class="form-group col-md-12">
                    <label for="checkuot-form-fname">Confirm Password</label>
                    <input name="cpassword" type="password" class="form-control" placeholder="">
                  </div>
                  <div class="text-right"> <button type="submit" class="btn btn-default">Update password</button> </div>
              </form>

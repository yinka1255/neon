    ...
    <section class="inner-header divider layer-overlay overlay-white-1" data-bg-img="{{asset('public/customer/images/sub_banner.jpg')}}">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-center" style="color: #fff;">Checkout</h2>
              <ol class="breadcrumb text-center text-white mt-10">
                <li><a href="#" style="color: #fff;">Home</a></li>
                <li class="active text-silver-gray" style="color: #fff;">Checkout</li>
              </ol>
            </div>
          </div>
        </div>
                ...
                <div class="billing-details">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label for="checkuot-form-fname">Contact person</label>
                      <input id="name" name="contact_person" class="form-control" placeholder="Full Name">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="checkuot-form-lname">Phone</label>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="email" name="email" value="{{Auth::user()->email}}" type="email" class="form-control" placeholder="Email Address">
                      </div>
                      <div class="form-group">
                        <label for="checkuot-form-address">Address</label>
                        <input id="checkuot-form-address" name="address" type="text" class="form-control" placeholder="Street address">
                      </div>
                    </div>
...
<form>
    <script>
        function payWithPaystack(){
            ...
            var email = $("#email").val();
            var phone = $("#phone").val();
            var amount = <?php echo str_replace(',', '', Cart::subtotal()) + 1500; ?>;
            ...
            var handler = PaystackPop.setup({
                ...
                callback: function(response){
                    getSuccess("We appreciate your patronage. We would definetly get back to ypu within 24 hours");
